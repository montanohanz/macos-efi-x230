 ...
 *
 * Disassembly of DSDT.aml, Thu May 16 15:57:57 2019
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000FF55 (65365)
 *     Revision         0x01 **** 32-bit table (V1), no 64-bit math support
 *     Checksum         0xD1
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "TP-G2   "
 *     OEM Revision     0x00002650 (9808)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20160328 (538313512)
 */
DefinitionBlock ("", "DSDT", 1, "LENOVO", "TP-G2   ", 0x00002650)
{
    ...
    IRQNoFlags() { 0, 8, 11, 15 }
                ...
                Device (EC)
                {
                    ...
                    Method (_Q16, 0, NotSerialized)  // _Qxx: EC Query
                    {
                        ...
                        ElseIf (LEqual (VHYB (0x03, Zero), 0x03))
                        {
                            Notify (VID, 0x80)
                            Return (Zero)
                        }
    ...
    Method (_WAK, 1, NotSerialized)  // _WAK: Wake
    {
        ...
        If (LEqual (Arg0, 0x03))
        {
            ...
            If (VIGD)
            {
                ...
                {
                    \_SB.PCI0.VID.GDCS (One)
                }
                Else
                {
                    \_SB.PCI0.VID.GDCS (Zero)
                }
