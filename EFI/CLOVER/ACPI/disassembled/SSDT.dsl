 ...
 *
 * Disassembly of SSDT.aml, Thu May 16 15:57:58 2019
 *
 ...
 *     OEM ID           "APPLE "
 *     OEM Table ID     "CpuPm"
 *     OEM Revision     0x00015900 (88320)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20140424 (538182692)
 */
DefinitionBlock ("", "SSDT", 1, "APPLE ", "CpuPm", 0x00015900)
{
    ...
    Scope (\_PR.CPU0)
    {
        ...
        {
            Store ("ssdtPRGen version....: 15.9 / Mac OS X 10.11.1 (15B42)", Debug)
            Store ("target processor.....: i5-3210M", Debug)
            Store ("source processor.....: Intel(R) Core(TM) i5-3210M CPU @ 2.50GHz", Debug)
